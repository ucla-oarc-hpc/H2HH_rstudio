...
```{.bash}
ssh  -L 8787:nXXX:8787 username@hoffman2.idre.ucla.edu 
```
...
## Information on this RStudio Container (1)
...
- Rstudio container was built using Docker
  ...
  - RStudio containers are named `h2-rstudio_X.Y.Z.sif`
...
## Information on this RStudio Container (2)
...
:::{ style="text-align: center" }
<p align = "center"> <img src="cat.png" width="60%" height="60%"> </p> 
:::
:::
